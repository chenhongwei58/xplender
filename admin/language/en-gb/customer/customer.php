...
// Help
$_['help_safe']             = '选中时，可避免反欺诈系统识别此客户';
$_['help_points']           = '适用减号（-）减少奖励积分';

// Error
$_['error_warning']         = '警告: 详细检查相关错误！';
$_['error_permission']      = '警告: 无权限修改客户！';
$_['error_exists']          = '警告: E-Mail 已被注册使用了！';
$_['error_firstname']        = '姓名必须在 1 至 32 字符之间！';
$_['error_lastname']        = '姓氏必须在 1 至 32 字符之间!';
$_['error_email']           = 'E-Mail 无效！';
$_['error_telephone']       = '电话必须为 2 至 32 字符之间！';
$_['error_password']        = '密码密续为 4 至 20 字符之间！';
$_['error_confirm']         = '确认密码与密码不一致！';
$_['error_address_1']       = '地址必须为 2 至 128 字符之间！';
$_['error_city']            = '区/县必须为 2 至 128 字符之间！';
$_['error_postcode']        = '邮政编码必须为 2 至 10 字符之间！';
