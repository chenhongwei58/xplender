<?php
// HTTP
define('HTTP_SERVER', 'http://www.xplender.com/admin/');
define('HTTP_CATALOG', 'http://www.xplender.com/');

// HTTPS
define('HTTPS_SERVER', 'http://www.xplender.com/admin/');
define('HTTPS_CATALOG', 'http://www.xplender.com/');
...
define('DB_USERNAME', 'devadmin');
define('DB_PASSWORD', 'abcd1234');
define('DB_DATABASE', 'business');
define('DB_PORT', '3306');
